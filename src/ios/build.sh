...
lipo  "$OUTPUT_DIR"/../shared/Flurry/libFlurry_*.a -extract armv7 -extract  arm64  -o "$OUTPUT_DIR"/BuiltPlugin/iphone/libFlurry.a.tmp
$(xcrun -f bitcode_strip) "$OUTPUT_DIR"/BuiltPlugin/iphone/libFlurry.a.tmp -r -o "$OUTPUT_DIR"/BuiltPlugin/iphone/libFlurry.a
rm "$OUTPUT_DIR"/BuiltPlugin/iphone/libFlurry.a.tmp

lipo  "$OUTPUT_DIR"/../shared/Flurry/libFlurry_*.a -extract i386  -extract  x86_64  -o "$OUTPUT_DIR"/BuiltPlugin/iphone-sim/libFlurry.a.tmp
$(xcrun -f bitcode_strip) "$OUTPUT_DIR"/BuiltPlugin/iphone-sim/libFlurry.a.tmp -r -o "$OUTPUT_DIR"/BuiltPlugin/iphone-sim/libFlurry.a
rm "$OUTPUT_DIR"/BuiltPlugin/iphone-sim/libFlurry.a.tmp
